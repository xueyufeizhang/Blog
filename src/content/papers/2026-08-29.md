...
| **Sources**     | arxiv                                                                                                                            |
| **Focus**       | query-aware graph memory, long-term multimodal agent memory, combinatorial optimization for memory selection, evidence budgeting<br>查询感知图记忆, 长期多模态智能体记忆, 记忆选择的组合优化, 证据预算 |
